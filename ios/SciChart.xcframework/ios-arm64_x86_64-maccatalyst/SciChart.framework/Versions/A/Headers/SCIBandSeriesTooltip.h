 ...
 */
typedef SCIColor *_Nonnull(^SCIBandSeriesColorSelector) (SCIBandSeriesInfo *seriesInfo);
 ...
 */
- (instancetype)initWithSeriesInfo:(SCIBandSeriesInfo *)seriesInfo andColorSelector:(SCIBandSeriesColorSelector)colorSelector NS_DESIGNATED_INITIALIZER;
