...
//
// SCINotifiableSmartPropertyLong.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
- (instancetype)initWithListener:(SCIAction)listener andDefaultValue:(long)defaultValue;
