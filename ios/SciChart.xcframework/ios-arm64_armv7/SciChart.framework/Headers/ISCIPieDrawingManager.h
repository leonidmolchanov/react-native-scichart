...
//
// ISCIPieDrawingManager.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
- (void)drawPieSegments:(NSArray<SCIPieSegmentRenderPassData *> *)segments selectedSegmentOffset:(CGFloat)selectedSegmentOffset;
