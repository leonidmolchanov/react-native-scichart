...
- (id<ISCIPen2D>)internalCreatePenWithStyle:(SCIPenStyle *)style andOpacity:(float)opacity;

- (id<ISCIBrush2D>)internalCreateBrushWithStyle:(SCIBrushStyle *)style textureMappingMode:(SCITextureMappingMode)textureMappingMode andOpacity:(float)opacity;
