 ...
 */
- (instancetype)initWithItems:(const unsigned short *)items count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)addValues:(const unsigned short *)values count:(NSInteger)count NS_SWIFT_NAME(addValues(_:count:));
 ...
 * @param count The amount of values to add.
 */
- (void)addValues:(const unsigned short *)values startIndex:(NSInteger)startIndex count:(NSInteger)count NS_SWIFT_NAME(addValues(_:startIndex:count:));
