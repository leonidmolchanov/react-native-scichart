...
//
// SCIMasterSlaveTouchModifierBase.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@interface SCIMasterSlaveTouchModifierBase : SCIGestureModifierBase
