...
//
// SCISplineLineRenderableSeries.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
- (instancetype)initWithRenderPassData:(SCISplineLineRenderPassData *)renderPassData hitProvider:(id<ISCIHitProvider>)hitProvider nearestPointProvider:(id<ISCINearestPointProvider>)nearestPointProvider NS_DESIGNATED_INITIALIZER;
