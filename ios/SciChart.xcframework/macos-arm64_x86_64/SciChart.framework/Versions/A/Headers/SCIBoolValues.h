 ...
 */
- (instancetype)initWithItems:(const BOOL *)items count:(NSInteger)count NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)addValues:(const BOOL *)values count:(NSInteger)count NS_SWIFT_NAME(addValues(_:count:));
 ...
 * @param count The amount of values to add.
 */
- (void)addValues:(const BOOL *)values startIndex:(NSInteger)startIndex count:(NSInteger)count NS_SWIFT_NAME(addValues(_:startIndex:count:));
