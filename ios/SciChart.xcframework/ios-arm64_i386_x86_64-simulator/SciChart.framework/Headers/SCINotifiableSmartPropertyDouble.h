...
//
// SCINotifiableSmartPropertyDouble.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Creates a new instance of `SCINotifiableSmartPropertyDouble` class.
 ...
 */
- (instancetype)initWithListener:(SCIAction)listener andDefaultValue:(double)defaultValue;
